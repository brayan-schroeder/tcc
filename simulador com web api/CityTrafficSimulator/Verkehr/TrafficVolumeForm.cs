...
namespace CityTrafficSimulator.Verkehr
	...
	public partial class TrafficVolumeForm : Form
        ...
        public ListBox getListStartNodes() // Criado método para pegar todos as rotas de início
        {
            return lbStartNodes;
        }

        public ListBox getListDestinationNodes() // Criado método para pegar todos as rotas de destino
        {
            return lbDestinationNodes;
        }
